/**
 * ISO 4217 currency catalog. Every active circulating currency, with the
 * countries that use it. Groups pick one currency at creation; all expenses
 * and settlements in a group must use the group's currency.
 */
...
export const SUPPORTED_CURRENCY_CODES: string[] = CURRENCIES.map(c => c.code);

export const DEFAULT_CURRENCY = 'USD';

export const isSupportedCurrencyCode = (code: string): boolean =>
  SUPPORTED_CURRENCY_CODES.includes(code.toUpperCase());
